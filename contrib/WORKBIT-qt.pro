...
RESOURCES += src/qt/WORKBIT.qrc src/qt/WORKBIT_locale.qrc

TRANSLATIONS += src/qt/locale/WORKBIT_bg.ts \
                src/qt/locale/WORKBIT_de.ts \
                src/qt/locale/WORKBIT_en.ts \
                src/qt/locale/WORKBIT_es.ts \
                src/qt/locale/WORKBIT_fi.ts \
                src/qt/locale/WORKBIT_fr.ts \
                src/qt/locale/WORKBIT_it.ts \
                src/qt/locale/WORKBIT_ja.ts \
                src/qt/locale/WORKBIT_pl.ts \
                src/qt/locale/WORKBIT_pt.ts \
                src/qt/locale/WORKBIT_ru.ts \
                src/qt/locale/WORKBIT_sk.ts \
                src/qt/locale/WORKBIT_sv.ts \
                src/qt/locale/WORKBIT_vi.ts \
                src/qt/locale/WORKBIT_zh_CN.ts \
                src/qt/locale/WORKBIT_zh_TW.ts
