Contributing to WORKBIT Core
==================================

The WORKBIT Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WORKBIT Core project, and is not to be
confused with overall WORKBIT Network Protocol consensus changes.

Whether a pull request is merged into WORKBIT Core rests with the project merge
...
Patches that change WORKBIT consensus rules are considerably more involved than
...
Where a patch set proposes to change the WORKBIT consensus, it must have been
...
The project leader is the release manager for each WORKBIT Core release.
