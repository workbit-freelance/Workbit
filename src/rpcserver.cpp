...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "WORKBIT server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WORKBIT features */
        {"WORKBIT", "masternode", &masternode, true, true, false},
        {"WORKBIT", "listmasternodes", &listmasternodes, true, true, false},
        {"WORKBIT", "getmasternodecount", &getmasternodecount, true, true, false},
        {"WORKBIT", "masternodeconnect", &masternodeconnect, true, true, false},
        {"WORKBIT", "masternodecurrent", &masternodecurrent, true, true, false},
        {"WORKBIT", "masternodedebug", &masternodedebug, true, true, false},
        {"WORKBIT", "startmasternode", &startmasternode, true, true, false},
        {"WORKBIT", "createmasternodekey", &createmasternodekey, true, true, false},
        {"WORKBIT", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"WORKBIT", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"WORKBIT", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"WORKBIT", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"WORKBIT", "getmasternodescores", &getmasternodescores, true, true, false},
        {"WORKBIT", "mnbudget", &mnbudget, true, true, false},
        {"WORKBIT", "preparebudget", &preparebudget, true, true, false},
        {"WORKBIT", "submitbudget", &submitbudget, true, true, false},
        {"WORKBIT", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"WORKBIT", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"WORKBIT", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"WORKBIT", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"WORKBIT", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"WORKBIT", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"WORKBIT", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"WORKBIT", "checkbudgets", &checkbudgets, true, true, false},
        {"WORKBIT", "mnsync", &mnsync, true, true, false},
        {"WORKBIT", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> WORKBIT-cli " + methodname + " " + args + "\n";
}
