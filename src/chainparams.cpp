...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0,      uint256("0x00000ecdcde9cad4556d824b77f710a33f6ae25df53217dcd034adbef91a2ee7"));
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1607892301, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 8888;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // WORKBIT starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // WORKBIT: 1 day
        nTargetSpacing = 2 * 60;  // WORKBIT: 2 minutes
        nMaturity = 10;
        ...
        nLastPOWBlock = 650;
        nModifierUpdateBlock = 1; // we use the version 2 for WRB
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1607892301;
        genesis.nBits = 504365040;
        genesis.nNonce = 4506110;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000ecdcde9cad4556d824b77f710a33f6ae25df53217dcd034adbef91a2ee7"));
        assert(genesis.hashMerkleRoot == uint256("0xce94b6c141f89fd2515763a81701a984e430bada2b31f071b63f038b62b9de2c"));

        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("212.8.246.186", "212.8.246.186"));
        vSeeds.push_back(CDNSSeedData("212.8.246.179", "212.8.246.179"));


        // WORKBIT addresses start with 'P'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 29);
        // WORKBIT script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 8);
        // WORKBIT private keys start with 'K'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 46);
        // WORKBIT BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // WORKBIT BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // WORKBIT BIP44 coin type is '222' (0x800000de)
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // WORKBIT: 1 day
        nTargetSpacing = 2 * 60;  // WORKBIT: 1 minute
        nLastPOWBlock = 300;
        nMaturity = 15;
...
//        assert(hashGenesisBlock == uint256("0x000008bee9b7f7714e2c7cdaf80af916a107aa3b0f61b91496e614bea9f2fb3d"));
        ...
        // Testnet WORKBIT addresses start with 'g'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 98);
        // Testnet WORKBIT script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 12);
        // Testnet private keys start with 'k'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 108);
        // Testnet WORKBIT BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet WORKBIT BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet WORKBIT BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // WORKBIT: 1 day
        nTargetSpacing = 2 * 60;        // WORKBIT: 2 minutes
