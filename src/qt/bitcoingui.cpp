                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WORKBIT Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    web->setToolTip(QApplication::translate("OverviewPage", "Visit the official WORKBIT Website.", nullptr));
#endif // QT_NO_TOOLTIP
    web->setText(QApplication::translate("OverviewPage", "<a href=\"http://www.WORKBIT.org\"><img src=\":/icons/blank\" width=\"102\" height=\"21\"></a>", nullptr));
...
#ifndef QT_NO_TOOLTIP
    facebook->setToolTip(QApplication::translate("OverviewPage", "Follow WORKBIT on Facebook.", nullptr));
#endif // QT_NO_TOOLTIP
    facebook->setText(QApplication::translate("OverviewPage", "<a href=\"https://www.facebook.com/WORKBITexchange\"><img src=\":/icons/blank\" width=\"21\" height=\"21\"></a>", nullptr));
...
#ifndef QT_NO_TOOLTIP
    twitter->setToolTip(QApplication::translate("OverviewPage", "Follow WORKBIT on Twitter.", nullptr));
#endif // QT_NO_TOOLTIP
    twitter->setText(QApplication::translate("OverviewPage", "<a href=\"https://twitter.com/WORKBIT\"><img src=\":/icons/blank\" width=\"21\" height=\"21\"></a>", nullptr));
...
#ifndef QT_NO_TOOLTIP
    discord->setToolTip(QApplication::translate("OverviewPage", "Join the official WORKBIT Discord community.", nullptr));
#endif // QT_NO_TOOLTIP
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    //sendCoinsAction->setStatusTip(tr("Send coins to a WORKBIT address"));
    sendCoinsAction->setToolTip(tr("Send coins to a WORKBIT address"));
    ...
    //receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and WORKBIT: URIs)"));
    receiveCoinsAction->setToolTip(tr("Request payments (generates QR codes and WORKBIT: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WORKBIT Core"), this);
    aboutAction->setStatusTip(tr("Show information about WORKBIT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WORKBIT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WORKBIT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WORKBIT addresses"));
    ...
    openAction->setStatusTip(tr("Open a WORKBIT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WORKBIT Core help message to get a list with possible WORKBIT command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WORKBIT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WORKBIT network", "", count));
}
...
{
    QString strTitle = tr("WORKBIT Core"); // default title
