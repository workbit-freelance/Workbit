...
/** Utility functions used by the WORKBIT Qt UI.
 */
namespace GUIUtil
{
...
// Render WORKBIT addresses in monospace font
...
// Parse "WORKBIT:" URI into recipient object, return true on successful parsing
