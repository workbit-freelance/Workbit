/* src/config/WORKBIT-config.h.  Generated from WORKBIT-config.h.in by configure.  */
/* src/config/WORKBIT-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef WORKBIT_CONFIG_H

#define WORKBIT_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.WORKBIT.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "WORKBIT Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "WORKBIT Core 1.5.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "WORKBIT"
