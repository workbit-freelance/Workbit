...
In order to support loading of multiple wallets in WORKBIT-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is WORKBIT.cpp.
...
Changes to WORKBIT.cpp
----------------------
WORKBIT.cpp is the entry point into WORKBIT-qt, and as such, will require some minor modifications to provide hooks for
