...
Intro
-----
WORKBIT (WORKBIT) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. WORKBIT utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run WORKBIT-qt.exe.

WORKBIT Core is the original WORKBIT client and it builds the backbone of the network.
However, it downloads and stores the entire history of WORKBIT transactions;
